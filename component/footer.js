    ...
    return (
        <div>
            <footer className="page-footer font-small blue-grey lighten-5">
                ...
                <div className="container text-center text-md-left mt-5">
                    <div className="row mt-3 dark-grey-text">
                        <div className="col-md-3 col-lg-4 col-xl-3 mb-4">
                            ...
                            <hr className="teal accent-3 mb-4 mt-0 d-inline-block mx-auto" style={{ width: 60+"px" }} />
                ...
                <div className="footer-copyright text-center text-black-50 py-3">© 2021 Copyright: <a className="dark-grey-text" href="https://mdbootstrap.com/"> MDBootstrap.com</a>
                </div>
            </footer>
        </div>
    )
